...
echo "  4. Run your solution.py against both incidents and save the output"
echo "     as $DEST/answers.json (see the use case README, 'What you submit')"
echo "  5. Write $DEST/README.md - design, your understanding of the problem,"
echo "     why you took the approach you did, your name, phone, and email"
echo "  6. python -m scoring.cli --usecase $USECASE_DIR --submission $DEST"
echo "     (Correctness will show 0 - that component is judged manually, ignore it)"
echo "  7. git add $DEST && git commit -m \"Attempt $USECASE_DIR\""
echo "  8. git push -u origin $BRANCH"
echo "  9. Open a pull request into main - this triggers the automated"
echo "     components, see the Actions tab; correctness is added manually"
echo ""
